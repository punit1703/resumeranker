export default function HeroSection() {
  return (
    <section className="relative overflow-hidden bg-gradient-to-b from-indigo-100 via-white to-white">
      ...
      <div className="max-w-7xl mx-auto px-6 py-20 sm:py-24 md:py-32 text-center">
        
        <span className="inline-flex items-center gap-2 mb-6 px-4 py-2 text-xs sm:text-sm rounded-full bg-indigo-50 border border-indigo-400 text-indigo-500">
        ...
        <p className="max-w-2xl mx-auto text-base sm:text-lg md:text-xl text-gray-600 mb-10 leading-relaxed">
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-4 sm:gap-6">
          <a
            href="/analyze"
            className="px-7 py-4 rounded-xl bg-indigo-400 text-white text-sm sm:text-base font-semibold transition duration-200 ease-in-out
            shadow-lg shadow-indigo-600/30 hover:bg-indigo-500 hover:-translate-y-1 hover:scale-105"
          >
            Analyze Resume →
          </a>
